...
This is an API for a to-do list app, based on the project idea described at https://roadmap.sh/projects/todo-list-api. It is written in TypeScript and uses MongoDB as a database.
